...
## Create Configs for Iceberg table management
...
@dataclass
class TableConfig:
    """Configuration for a single Iceberg table."""
    table_name: str
    schema_name: str
    location: str
...
@dataclass
class TablesConfig:
    """Configuration for all Iceberg tables."""
    bronze: TableConfig
    silver: TableConfig
    gold: TableConfig
...
class ConversionConfig:
    """Configuration for parquet to Iceberg conversion."""
...
class RegistryConfig:
    """Configuration for table registry."""
    file_path: Path
    persist: bool

@dataclass
class IcebergConfig:
    """Configuration for Iceberg table management."""
    root_dir: Path
